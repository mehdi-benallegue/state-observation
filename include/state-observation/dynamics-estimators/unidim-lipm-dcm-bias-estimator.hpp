...
class STATE_OBSERVATION_DLLAPI UnidimLipmDcmBiasEstimator
{
private:
...
public:
  ...
  UnidimLipmDcmBiasEstimator(double omega_0,
  ...
  /// @param initBiasUncertainty the uncertainty in the bias initial value in meters
  UnidimLipmDcmBiasEstimator(bool measurementIsWithBias,
                             double measuredDcm,
                             double measuredZMP,
                             double omega_0,
                             double dt = defaultDt_,
...
private:
  ...
  UnidimLipmDcmBiasEstimator() = delete;
